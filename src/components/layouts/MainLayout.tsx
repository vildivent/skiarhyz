  ...
  return (
    <>
      <main className="relative flex min-h-screen w-full flex-col">
        ...
        <div className="absolute z-10 h-20 w-full bg-linear-to-b from-[#2A3061] to-transparent opacity-50 sm:h-52" />
        ...
        <div className="absolute z-10 mt-[55vh] flex w-full flex-col lg:mt-[70vh] xl:mt-[80vh] 2xl:mt-[80vh]">
          <div
            className="bg-blue-3 relative flex h-[35vh] items-center justify-center px-5"
            style={{
              clipPath: "polygon(0 0, 0 86%, 100% 100%, 100% 29%)",
            }}
          >
            <h1 className="font-h relative z-1 text-center text-3xl font-bold text-white xl:text-4xl 2xl:text-5xl">
              {title}
            </h1>
            <div
