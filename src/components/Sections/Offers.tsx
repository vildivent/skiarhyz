...
const Offers = () => {
  ...
  return (
    <section className="bg-blue-2 flex flex-col gap-10 p-5 pt-10">
      <div className="flex flex-col items-center gap-5 lg:flex-row lg:justify-around">
        <div className="text-white-1 flex flex-col justify-center gap-5">
          <h2 className="font-h relative text-center text-2xl font-bold text-white xl:text-3xl 2xl:text-4xl">
            Мои предложения:
          </h2>
          <ol className="text-gray-4 ml-5 list-decimal font-bold">
            <li>
              <span
              ...
              <span className="font-normal text-white">
                занятия продолжительностью от 2 до 4 часов.
              </span>
            </li>
            <li>
              <span
          ...
          <div>
            ...
            <ul className="text-gray-4 list-inside list-disc font-bold">
              <li
                className="cursor-pointer hover:text-white"
                onClick={() =>
                  clickModalHandler(
                    <>
                      <h3 className="font-h text-blue-4 mb-3 text-center text-2xl font-bold">
                        Базовая техника
                      </h3>
                      <p>
