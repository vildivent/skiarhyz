  ...
  return (
    ...
    >
      <TextCard type="right">
        ...
        <p>
          Оптимальное соотношение цены и результата под руководством опытного
          Инструктора.
        </p>
        <p>
          При значительном количестве учеников в группе привлекаются
          дополнительные инструкторы. Количество инструкторов определяется
          эффективностью и безопасностью занятия. За дополнительных инструкторов
          плата не взымается.
        </p>
      </TextCard>
